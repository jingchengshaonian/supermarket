...
constexpr auto qt_meta_stringdata_CLASSbackENDCLASS = QtMocHelpers::stringData(
    "back",
    "send",
    "",
    "m",
...
void back::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->send((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<QString>>(_a[2]))); break;
        ...
        {
            using _t = void (back::*)(QString , QString );
            if (_t _q_method = &back::send; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void back::send(QString _t1, QString _t2)
{
